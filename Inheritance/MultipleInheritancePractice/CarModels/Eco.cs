...
namespace CarModels
{
    public class Eco:Car,IBrand
    {
        ...
        public Eco(string brandName,string modelName,string fuelType,int numberOFSeats,string color,double capacity,double kmDriven,string engineNumber,string chasisNumber):base(fuelType,numberOFSeats,color,capacity,kmDriven)
        {
            s_makingID++;
